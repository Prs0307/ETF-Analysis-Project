...
const Table: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="w-full bg-white shadow-md rounded-lg overflow-hidden" style={{ boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.1)' }}>
        ...
        <div className="flex justify-between items-center p-4">
          ...
          <input
          type="text"
        className="product-textbox clearable"
      ...
      <select className="date-dropdown" value={selectedDate} onChange={handleDateChange}>
        ...
        <div className="overflow-x-auto overflow-y-auto h-96 shadow-xl">
          <table className="w-full divide-y divide-gray-300 text-black">
            <thead className="bg-green-700 text-black sticky top-0">
              <tr>
...
<div className="flex justify-center items-center mt-4">
  <div className="mr-4">
    {rowsPerPage === 5 ? (
      <button
        className="px-4 py-2 border border-gray-300 rounded-md bg-green-700 text-white hover:bg-green-600"
        onClick={showMore}
      >
        + Show More
      </button>
      ...
      <button
        className="px-4 py-2 border border-gray-300 rounded-md bg-red-700 text-white hover:bg-red-600"
        onClick={showLess}
      >
        - Show Less
      </button>
  ...
  <div className="flex">
    ...
    <div className="flex">
      <button
        className={`px-3 py-2 rounded-md ${currentPage === 1 ? 'bg-gray-400 text-white' : 'bg-white text-black'
        } hover:bg-gray-300`}
      ...
      <button
        className={`px-3 py-2 rounded-md ${currentPage === totalPages ? 'bg-gray-400 text-white' : 'bg-white text-black'
        } hover:bg-gray-300`}
