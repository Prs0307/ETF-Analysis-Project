            ...
            <tbody className="bg-white divide-y divide-gray-300">
              ...
              {data["results"].map((data, index) => (
                <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-[#c3e4f2]'}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">{data.asset_class}</td>
...
// const Table: React.FC = ({data}) => {
//  let tableData: TableData[]=data["results"];

  
  // try {
  //   if(data["results"].length > 0) {
  //     console.log(true);
  //  const tableData: TableData[]=data["results"];
...
//   return (
//    <div>
//     {data["results"]? ( <div className="flex justify-center items-center h-[100] bg-white ">
